...
* The size of a type is ill-defined; this makes sense, because classically
  size is not a homotopy invariant. The size of a *set* is well-defined (see
  chapter on cardinals).

* Explain that by "=", we really mean equality. Explain that homotopic paths
  really are *the same* in HoTT.

* Explain term constructors.
