...
\frame[t]{\frametitle{How are types like spaces?}
  \begin{itemize}
    \item Functions are automatically continuous/functorial:
    \[ (x = y) \longrightarrow (f(x) = f(y)). \]

    \item Type families $P : X \to \U$ automatically behave like fibrations, in
    that they have the path lifting property:
