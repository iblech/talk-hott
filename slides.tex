...
\note{
  There is also lots of activity in type theory, $(\infty,1)$-category theory,
  the theory of simplicial and cubical sets, computer-aided reasoning, \ldots
}
...
\frame[t]{\frametitle{References}
  ...
  \floatbox{-260}{46}{\includegraphics[scale=0.5]{hott-book}}
}
...
* Stress applicability of HoTT better. Also mention the HoTT approach
  to field theory of Urs.
